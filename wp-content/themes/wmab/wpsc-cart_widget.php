...
<?php if(wpsc_cart_item_count() > 0): ?>
    ...
    <!--div class="table">
    <ul id="cart-head">
    	<li id="product"><?php _e('Product', 'wpsc'); ?></li>
    	<li id="quantity"><?php _e('Qty', 'wpsc'); ?></li>
    	<li id="price"><?php _e('Price', 'wpsc'); ?></li>
    	<li id="remove">&nbsp;</li>
    </ul>
	<?php while(wpsc_have_cart_items()): wpsc_the_cart_item(); ?>
	<ul>
    	<li class="product-name"><a href="<?php echo wpsc_cart_item_url(); ?>"><?php echo wpsc_cart_item_name(); ?></a></li>
    	<li id="quantity"><?php echo wpsc_cart_item_quantity(); ?></li>
    	<li id="price"><?php echo wpsc_cart_item_price(); ?></li>
    	<li class="cart-widget-remove"><form action="" method="post" class="adjustform">
	...
	<?php endwhile; ?>
    <ul id="cart-foot">
    	<li class="cart-widget-count"><?php printf( _n('%d item', '%d items', wpsc_cart_item_count(), 'wpsc'), wpsc_cart_item_count() ); ?></li>
    	<li class="pricedisplay checkout-total"><?php _e('Total', 'wpsc'); ?>: <?php echo wpsc_cart_total_widget( false, false ,false ); ?><br />
					<small><?php _e( 'excluding shipping and tax', 'wpsc' ); ?></small></li>
    	<li id='cart-widget-links'>
