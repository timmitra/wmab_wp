...
<?php // */ ?>
	...
	<?php if(wpsc_display_products()): ?>
		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<div class="entry product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> group">   
					<?php if(wpsc_show_thumbnails()) :?>
					<div class="entry-image" style="/*width:<?php echo $image_width; ?>;*/" id="imagecol_<?php echo wpsc_the_product_id(); ?>">
				...
				<div class="entry-textblock">
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									...
									<?php if(wpsc_show_pnp()) : ?>
										<p class="entry-price"><?php _e('Shipping', 'wpsc'); ?>:<span class="pp_price"><?php echo wpsc_product_postage_and_packaging(); ?></span></p>
									<?php endif; ?>							
								<?php endif; ?>
					...
					<?php // */ ?>
				</div><!--close entry-description-->
				<!--/div--><!--close productcol-->
				</div><!--close entry-textblock-->
